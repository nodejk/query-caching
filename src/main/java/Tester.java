...
//
//        Cache<RelOptMaterialization> cache = new Cache<>(new _LRUPolicy<>(), Dimension.SIZE(10 * ONE_GB));
//        int numDerivable = 0;
//        outerloop:
//        for (int i = 0; i < queries.size(); i++) {
//            System.out.println("=================================");
...
//
//        for (int i = 0; i < 100; i++) {
//            this.testNormalDerivability(queries, mats);
////            System.exit(0);
//
//        }
//
...
//            String query = queries.get(i);
//            RelNode logical = this.executor.getLogicalPlan(query);
//
//            for (RelOptMaterialization m : mats) {
//                if (this.optimizer.substitute(m, logical) != null) {
//                    continue ql;
//
//                }
//            }
...
////    }
//
//    public void testDerivabilityPerfRun() {
//        try {
//            this.testDerivabilityPerf();
//        } catch (Exception e) {
//            return;
//        }
//    }
